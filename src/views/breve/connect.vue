    ...
    <div style="border-left: 500px;">
        <div style="width:900px;">
            <table border="1px" bordercolor="#E4E7ED" ref="Res" :model="Res" width="950xp" cellpadding="5"
                ...
                <tr>
                    <td colspan="4">
                        ...
                        <h2 style="margin-right: 350px;">固定资产交接表</h2>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    border-style: none;text-shadow: none;-webkit-appearance: none;outline-color: transparent;box-shadow: none"></td>
                     ...
                     <td width="225"><input type="text" v-model="Res.Returndate"
                             style="background-color:#FFFFFF;outline-color: invert;outline-style: none;outline-width: 0px;border: none;
                     border-style: none;text-shadow: none;-webkit-appearance: none;outline-color: transparent;box-shadow: none"></td>                   
                </tr>    
            </table>
            <table border="1px" bordercolor="#E4E7ED" ref="Res" :model="Res" width="950xp" cellpadding="5"
                ...
                <tr>
                    <td align="left" width="225" style="background-color:#F2F6FC;">资产名称</td>
                    <td width="225" colspan="3"><input type="text" v-model="Res.Assetname"
                            style="background-color:#FFFFFF;outline-color: invert;outline-style: none;outline-width: 0px;border: none;
                border-style: none;text-shadow: none;-webkit-appearance: none;outline-color: transparent;box-shadow: none"></td>
                </tr>
                <tr>
                    <td align="left" width="225" style="background-color:#F2F6FC;">资产型号</td>
                    <td width="225" colspan="3"><input type="text" v-model="Res.Assetmodel"
                            style="background-color:#FFFFFF;outline-color: invert;outline-style: none;outline-width: 0px;border: none;
                border-style: none;text-shadow: none;-webkit-appearance: none;outline-color: transparent;box-shadow: none"></td>
                </tr>
                <tr>
                    <td align="left" width="225" style="background-color:#F2F6FC;">资料名称</td>
                    <td width="225" colspan="3"><input type="text" v-model="Res.Profilename"
                            style="background-color:#FFFFFF;outline-color: invert;outline-style: none;outline-width: 0px;border: none;
                border-style: none;text-shadow: none;-webkit-appearance: none;outline-color: transparent;box-shadow: none"></td>
                </tr>
    ...
    export default {
        ...
        methods: {
            onclick() {
                ...
                this.$axios.post("http://localhost:5000/Connect", this.Res).then((res) => {
                    if (res.data !=null) {
                        this.$message("数据提交成功!");
                    }
                    else {
